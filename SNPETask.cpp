...
bool SNPETask::init(const std::string& model_path, const runtime_t runtime)
{
    switch (runtime) {
        case CPU:
            ALOGD(__func__,"============CCCPPPUUUU======================", "");
            m_runtime = SNPE_RUNTIME_CPU;
            break;
        case GPU:
            ALOGD(__func__,"============GGGPPPUUUU======================", "");
            m_runtime = SNPE_RUNTIME_GPU;
            break;
        case GPU_FLOAT16:
            ALOGD(__func__,"============GGGPPPUUU16======================", "");
            m_runtime = SNPE_RUNTIME_GPU_FLOAT16;
            break;
        case DSP:
            ALOGD(__func__,"============DDDSSSPPP======================", "");
            m_runtime = SNPE_RUNTIME_DSP;
            break;
        case DSP_FIXED8:
            ALOGD(__func__,"============DDDSSSPPPD8======================", "");
            m_runtime = SNPE_RUNTIME_DSP_FIXED8_TF;
            break;
        case AIP:
            ALOGD(__func__,"============AAAIIIIPPP======================", "");
    ...
    ALOGD(__func__,"============Init fa1111======================", "");
    m_container = Snpe_DlContainer_Open(model_path.c_str());
    ALOGD(__func__,"============Init fa2222======================", "");
